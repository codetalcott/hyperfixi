 ...
 * @property {'implemented' | 'architecture-ready' | 'unknown' | 'not-implemented'} status - Implementation status
 * @property {boolean} tested - Whether pattern has tests
 ...
 * @returns {Pattern[]}
 */
export function getUntestedPatterns() {
