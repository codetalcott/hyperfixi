/**
 * JSX vocabularies + their injected grammar slices.
 *
 * Each language pairs a domain-authored {@link DomainVocabulary} (JSX verbs +
...
export interface JSXLanguageSource {
  readonly slice: GrammarProfileSlice;
  readonly vocab: DomainVocabulary;
}

/** Grammar slice + JSX vocabulary per supported language. */
export const JSX_LANGUAGES: Readonly<Record<string, JSXLanguageSource>> = {
