/**
 * FlowScript vocabularies + their injected grammar slices.
 *
 * Each language pairs a domain-authored {@link DomainVocabulary} (flow verbs +
...
export interface FlowLanguageSource {
  readonly slice: GrammarProfileSlice;
  readonly vocab: DomainVocabulary;
}

/** Grammar slice + FlowScript vocabulary per supported language. */
export const FLOW_LANGUAGES: Readonly<Record<string, FlowLanguageSource>> = {
