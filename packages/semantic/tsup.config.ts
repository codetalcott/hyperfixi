...
export default defineConfig([
  ...
  // Bengali browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-bn.bn.global.js
  // Generated by: node scripts/generate-bundle.mjs bn
  {
    entry: ['src/browser-bn.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticBn',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.bn.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Hindi browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-hi.hi.global.js
  // Generated by: node scripts/generate-bundle.mjs hi
  {
    entry: ['src/browser-hi.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticHi',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.hi.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Italian browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-it.it.global.js
  // Generated by: node scripts/generate-bundle.mjs it
  {
    entry: ['src/browser-it.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticIt',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.it.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Malay browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-ms.ms.global.js
  // Generated by: node scripts/generate-bundle.mjs ms
  {
    entry: ['src/browser-ms.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticMs',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.ms.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Polish browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-pl.pl.global.js
  // Generated by: node scripts/generate-bundle.mjs pl
  {
    entry: ['src/browser-pl.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticPl',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.pl.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Russian browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-ru.ru.global.js
  // Generated by: node scripts/generate-bundle.mjs ru
  {
    entry: ['src/browser-ru.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticRu',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.ru.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Thai browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-th.th.global.js
  // Generated by: node scripts/generate-bundle.mjs th
  {
    entry: ['src/browser-th.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticTh',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.th.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Tagalog browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-tl.tl.global.js
  // Generated by: node scripts/generate-bundle.mjs tl
  {
    entry: ['src/browser-tl.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticTl',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.tl.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Ukrainian browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-uk.uk.global.js
  // Generated by: node scripts/generate-bundle.mjs uk
  {
    entry: ['src/browser-uk.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticUk',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.uk.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // Vietnamese browser bundle (IIFE)
  // Output: hyperfixi-semantic.browser-vi.vi.global.js
  // Generated by: node scripts/generate-bundle.mjs vi
  {
    entry: ['src/browser-vi.ts'],
    outDir: 'dist',
    format: ['iife'],
    globalName: 'LokaScriptSemanticVi',
    minify: true,
    sourcemap: false,
    platform: 'browser',
    noExternal: ['@hyperfixi/i18n'],
    outExtension() {
      return { js: '.vi.global.js' };
    },
    esbuildOptions(options) {
      options.target = 'es2020';
      options.treeShaking = true;
  ...
  // All 25 languages are built as individual modules
  {
    entry: {
      'languages/ar': 'src/languages/ar.ts',
      'languages/bn': 'src/languages/bn.ts',
      ...
      'languages/it': 'src/languages/it.ts',
      'languages/ja': 'src/languages/ja.ts',
      'languages/ko': 'src/languages/ko.ts',
      'languages/ms': 'src/languages/ms.ts',
      'languages/pl': 'src/languages/pl.ts',
      'languages/pt': 'src/languages/pt.ts',
      'languages/qu': 'src/languages/qu.ts',
      'languages/ru': 'src/languages/ru.ts',
      'languages/sw': 'src/languages/sw.ts',
      'languages/th': 'src/languages/th.ts',
      'languages/tl': 'src/languages/tl.ts',
