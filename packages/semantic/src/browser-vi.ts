/**
 * Vietnamese Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.vi.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticVi.parse('toggle .active', 'vi');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: vi
// =============================================================================
...
export const VERSION = '1.0.0-vi';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['vi'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'vi') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: vi`);
  }
}
...
export { vietnameseTokenizer } from './tokenizers/vietnamese';
...
export { vietnameseProfile } from './generators/language-profiles';
