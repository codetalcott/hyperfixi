/**
 * Thai Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.th.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticTh.parse('toggle .active', 'th');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: th
// =============================================================================
...
export const VERSION = '1.0.0-th';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['th'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'th') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: th`);
  }
}
...
export { thaiTokenizer } from './tokenizers/thai';
...
export { thaiProfile } from './generators/language-profiles';
