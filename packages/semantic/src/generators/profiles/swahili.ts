...
export const swahiliProfile: LanguageProfile = {
  ...
  keywords: {
    ...
    clear: { primary: 'safisha', normalized: 'clear' },
    reset: { primary: 'anzisha-upya', normalized: 'reset' },
    breakpoint: { primary: 'nukta-simama', normalized: 'breakpoint' },
    go: { primary: 'nenda', alternatives: ['enda', 'elekea'], normalized: 'go' },
    scroll: { primary: 'sogeza', alternatives: ['skroli'], normalized: 'scroll' },
    push: { primary: 'sukuma', alternatives: ['push'], normalized: 'push' },
    replace: { primary: 'badilisha_url', alternatives: ['badili_url'], normalized: 'replace' },
    process: { primary: 'shughulikia', alternatives: ['changanua'], normalized: 'process' },
