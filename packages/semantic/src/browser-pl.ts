/**
 * Polish Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.pl.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticPl.parse('toggle .active', 'pl');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: pl
// =============================================================================
...
export const VERSION = '1.0.0-pl';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['pl'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'pl') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: pl`);
  }
}
...
export { polishProfile } from './generators/language-profiles';
