/**
 * Bengali Browser Bundle Entry Point
 *
 * Minimal single-language bundle.
 * Estimated size: ~71 KB (~25 KB gzip)
 *
 * @example
 * ```html
 * <script src="hyperfixi-semantic.bn.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticBn.parse('toggle .active', 'bn');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: bn
// =============================================================================
...
export const VERSION = '1.0.0-bn';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['bn'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'bn') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: bn`);
  }
}
...
export { bengaliTokenizer } from './tokenizers/bengali';
...
export { bengaliProfile } from './generators/language-profiles';
