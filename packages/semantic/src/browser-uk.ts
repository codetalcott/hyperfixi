/**
 * Ukrainian Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.uk.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticUk.parse('toggle .active', 'uk');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: uk
// =============================================================================
...
export const VERSION = '1.0.0-uk';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['uk'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'uk') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: uk`);
  }
}
...
export { ukrainianProfile } from './generators/language-profiles';
