/**
 * Tagalog Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.tl.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticTl.parse('toggle .active', 'tl');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: tl
// =============================================================================
...
const SUPPORTED_LANGUAGES = ['tl'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'tl') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: tl`);
  }
}
...
export { tagalogTokenizer } from './tokenizers/tl';
...
export { tagalogProfile } from './generators/language-profiles';
