 ...
 * array included (`set el to #panel`, `set x to [1, 2]`). These patterns
 * once copied the narrower list, so such a set was lost in de/fr/id/ms/pt.
 */
