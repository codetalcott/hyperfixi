/**
 * Russian Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.ru.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticRu.parse('toggle .active', 'ru');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: ru
// =============================================================================
...
const SUPPORTED_LANGUAGES = ['ru'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'ru') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: ru`);
  }
}
...
export { russianProfile } from './generators/language-profiles';
