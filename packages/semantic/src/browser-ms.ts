/**
 * Malay Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.ms.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticMs.parse('toggle .active', 'ms');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: ms
// =============================================================================
...
export const VERSION = '1.0.0-ms';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['ms'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'ms') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: ms`);
  }
}
...
export { malayTokenizer } from './tokenizers/ms';
...
export { malayProfile } from './generators/language-profiles';
