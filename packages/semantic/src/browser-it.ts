/**
 * Italian Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.it.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticIt.parse('toggle .active', 'it');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: it
// =============================================================================
...
function validateLanguage(language: string): void {
  if (language !== 'it') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: it`);
  }
}
...
export { italianProfile } from './generators/language-profiles';
