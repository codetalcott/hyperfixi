...
describe('Enhanced Property Expressions Integration', () => {
  ...
  describe('Cross-expression compatibility', () => {
    it('should work together for complex property access', async () => {
      ...
      // Test my expression
      const myResult = await enhancedPropertyExpressions.my.evaluate(context, { 
      ...
      const itsResult = await enhancedPropertyExpressions.its.evaluate(context, { 
        target: mockElement, 
        property: 'dataset.userId' 
      });
      ...
      const attrResult = await enhancedPropertyExpressions.attribute.evaluate(context, { 
        element: mockElement, 
  ...
  describe('Performance tracking', () => {
    it('should track evaluation history for all property expressions', async () => {
      ...
      const myExpr = enhancedPropertyExpressions.my;
      const itsExpr = enhancedPropertyExpressions.its;
      const attrExpr = enhancedPropertyExpressions.attribute;
  ...
  describe('Type safety', () => {
    it('should have consistent metadata', () => {
      const expressions = Object.values(enhancedPropertyExpressions);
  ...
  describe('Real-world scenarios', () => {
    it('should handle form field access patterns', async () => {
      ...
      const nameResult = await enhancedPropertyExpressions.attribute.evaluate(context, { 
        element: formElement, 
        attribute: 'name' 
      });

      // Access validation state
      const validityResult = await enhancedPropertyExpressions.its.evaluate(context, { 
        target: formElement, 
