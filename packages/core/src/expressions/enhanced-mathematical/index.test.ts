...
describe('Enhanced Mathematical Expressions Integration', () => {
  ...
  describe('Expression registry', () => {
    it('should provide all mathematical expressions', () => {
      expect(enhancedMathematicalExpressions.addition).toBeInstanceOf(EnhancedAdditionExpression);
      expect(enhancedMathematicalExpressions.subtraction).toBeInstanceOf(EnhancedSubtractionExpression);
      expect(enhancedMathematicalExpressions.multiplication).toBeInstanceOf(EnhancedMultiplicationExpression);
      expect(enhancedMathematicalExpressions.division).toBeInstanceOf(EnhancedDivisionExpression);
      expect(enhancedMathematicalExpressions.modulo).toBeInstanceOf(EnhancedModuloExpression);
    });
  });
  ...
  describe('Complex calculations', () => {
    it('should handle sequential operations', async () => {
      ...
      const addition = enhancedMathematicalExpressions.addition;
      const multiplication = enhancedMathematicalExpressions.multiplication;
      const subtraction = enhancedMathematicalExpressions.subtraction;
  ...
  describe('Type safety', () => {
    it('should have consistent metadata', () => {
      const expressions = Object.values(enhancedMathematicalExpressions);
