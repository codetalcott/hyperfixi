/**
 * IncrementCommand V2 - Enhanced with parseInput() for RuntimeBase
 * Non-destructive wrapper that extends the original IncrementCommand
 */

import { IncrementCommand as IncrementCommandV1 } from '../../commands/data/increment';
...
/**
 * Enhanced IncrementCommand with parseInput() method for tree-shakable RuntimeBase
 *
 * This wrapper extends the original IncrementCommand and adds argument parsing
 * logic that was previously in Runtime.executeEnhancedCommand() (lines 1391-1445).
 */
export class IncrementCommand extends IncrementCommandV1 {
  /**
  ...
  // execute() is inherited from IncrementCommandV1 - no changes needed!
}
