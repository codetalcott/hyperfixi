...
test.describe('Basics @gallery @interaction', () => {
  test('01-hello-world: click puts text into output @quick', async ({ page }) => {
    const collector = await setup(page, '/examples/events-and-dom/hello-world.html');
    await page.locator('button').first().click();
    await expect(page.locator('#output')).toHaveText('Hello, HyperFixi');
    expectNoCriticalErrors(collector);
  });

  test('02-toggle-class: click toggles .active on #box @quick', async ({ page }) => {
    const collector = await setup(page, '/examples/toggle-and-state/toggle-class.html');
  ...
  test('03-show-hide: show and hide commands @quick', async ({ page }) => {
    const collector = await setup(page, '/examples/events-and-dom/show-hide.html');
  ...
  test('04-input-mirror: typing mirrors to output @quick', async ({ page }) => {
    const collector = await setup(page, '/examples/events-and-dom/input-mirror.html');
  ...
  test('05-counter: increment, decrement, reset @quick', async ({ page }) => {
    const collector = await setup(page, '/examples/events-and-dom/counter.html');
...
test.describe('Intermediate @gallery @interaction', () => {
  test('01-form-validation: email validation', async ({ page }) => {
    const collector = await setup(page, '/examples/forms/form-validation.html');
  ...
  test('02-fetch-data: load user @network', async ({ page }) => {
    const collector = await setup(page, '/examples/fetch-and-async/fetch-data.html');
  ...
  test('03-fade-effects: toggle fade class', async ({ page }) => {
    const collector = await setup(page, '/examples/animation/fade-effects.html');
  ...
  test('04-tabs: switching tabs shows correct content', async ({ page }) => {
    const collector = await setup(page, '/examples/navigation/tabs.html');
  ...
  test('05-modal: open and close info modal', async ({ page }) => {
    const collector = await setup(page, '/examples/dialogs/modal.html');
  ...
  test('06-native-dialog: open and close info dialog', async ({ page }) => {
    const collector = await setup(page, '/examples/dialogs/native-dialog.html');
  ...
  test('07-dialog-toggle: toggle dialog', async ({ page }) => {
    const collector = await setup(page, '/examples/dialogs/dialog-toggle.html');
...
test.describe('Advanced @gallery @interaction', () => {
  test('01-color-cycling: pointerdown changes color', async ({ page }) => {
    const collector = await setup(page, '/examples/animation/color-cycling.html');
  ...
  test('03-sortable-list: delete removes item', async ({ page }) => {
    const collector = await setup(page, '/examples/drag-and-drop/sortable-list.html');
...
test.describe('Landing Page @gallery @interaction', () => {
  test('clipboard-copy: click executes without errors', async ({ page, context }) => {
    ...
    const collector = await setup(page, '/examples/js-interop/clipboard-copy.html');
  ...
  test('color-cycling: pointerdown changes color', async ({ page }) => {
    const collector = await setup(page, '/examples/animation/color-cycling-simple.html');
    const box = page.locator('#color-box');
  ...
  test('async-fetch: fetch todo from API @network', async ({ page }) => {
    const collector = await setup(page, '/examples/fetch-and-async/async-fetch.html');
  ...
  test('js-interop: date/time button populates result', async ({ page }) => {
    const collector = await setup(page, '/examples/js-interop/js-interop.html');
