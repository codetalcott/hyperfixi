...
> how `PARSER_FIX_STATUS.md` died (deleted 2026-08-07; its name promised an
...
| **`set <idref> to <value>` / js property-path args no-op** | medium — silent no-effect on shipped pages | ✅ execution-gate allowlist entries | families 1/6 in [HANDOFF-shipped-examples-execution.md](./archive/handoffs/HANDOFF-shipped-examples-execution.md) |
...
harness lessons: [HANDOFF-shipped-examples-execution.md](./archive/handoffs/HANDOFF-shipped-examples-execution.md).
...
[HANDOFF-command-word-in-if-condition.md](./archive/handoffs/HANDOFF-command-word-in-if-condition.md).
...
- **2026-07-29** — two entries added from the Arc B examples sweep: the
  ...
  here. Triage table:
  [HANDOFF-command-arch-metadata.md](./archive/handoffs/HANDOFF-command-arch-metadata.md) § F-B4a.
...
- **2026-07-27** — shipped-examples execution gate landed: `examples/**`
  ...
  [HANDOFF-shipped-examples-execution.md](./archive/handoffs/HANDOFF-shipped-examples-execution.md).
...
- **2026-07-27** — implicit-multiline `if` swallowing the following line into its
  ...
  [HANDOFF-implicit-multiline-if.md](./archive/handoffs/HANDOFF-implicit-multiline-if.md) (read its
...
- **#785** (2026-07-27) — `then` as a command separator in `if`/`unless`, `def` /
  ...
  [HANDOFF-if-block-then-separator.md](./archive/handoffs/HANDOFF-if-block-then-separator.md)
...
- **#784** — shipped-sources validity gate + `ParseResult.recovered`. Brief:
  [HANDOFF-parse-success-and-doc-examples.md](./archive/handoffs/HANDOFF-parse-success-and-doc-examples.md).
- 2026-01-30 — behavior parameters shadowing command names. **Resolved**;
  its report `PARSER_FIX_STATUS.md` was deleted 2026-08-07 (recover via git history).
