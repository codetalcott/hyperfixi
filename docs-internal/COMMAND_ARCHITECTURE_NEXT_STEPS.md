...
| --- | ----- | ---------- | ------ |
| ~~D — target-resolution consolidation~~ | **DONE** (#796/#797/#798) | ✅ + 36 new tests pinning the rung order and both selector shapes | [HANDOFF-command-arch-target-resolution.md](./archive/handoffs/HANDOFF-command-arch-target-resolution.md) — now a record, not a plan |
| ~~C — output contract~~ | **DONE** (#801/#802/#803/#805/#806) | ✅ the per-command `it` audit, both execution paths, 45 of 59 commands | [HANDOFF-command-arch-output-contract.md](./archive/handoffs/HANDOFF-command-arch-output-contract.md) — now a record, not a plan |
| ~~A — command manifest~~ | **DONE** (#811/#813/#814/#815/#817/#818/#819) | ✅ the 19-test bidirectional audit + the manifest's §7; classification debt is **0** | [HANDOFF-command-arch-manifest.md](./archive/handoffs/HANDOFF-command-arch-manifest.md) — now a record, not a plan |
| ~~B — metadata single-sourcing~~ | **DONE** (#823/#824/#825/#826/#827/#828) | ✅ the 7-test docs-coverage gate + §9's compatibility coupling + the static/instance bridge invariant; `metadataOf()` deleted, its check now `TS2322` | [HANDOFF-command-arch-metadata.md](./archive/handoffs/HANDOFF-command-arch-metadata.md) — now a record, not a plan |
| ~~E — generated static bundles~~ | **DONE** (#829/#830/#831/#832/#835/#836) | ✅ `generate:bundles:check` in CI's generated-artifacts step; hybrid-complete's executor switches AND `HYBRID_PARSER_TEMPLATE` are both generated | [HANDOFF-command-arch-bundles.md](./archive/handoffs/HANDOFF-command-arch-bundles.md) — now a record, not a plan |
| ~~F — schema-driven mappers + scaffolder~~ | **DONE** (#838/#839/#840) — 43 of 47 mappers deleted, 1301 → 448 lines | ✅ `check:mapper-parity` (332-case oracle, byte-identical regeneration) + `ast-shape-consistency` + semantic suite + ten-signal ratchet | [HANDOFF-command-arch-mappers.md](./archive/handoffs/HANDOFF-command-arch-mappers.md) — now a record, not a plan |
...
[HANDOFF-command-arch-target-resolution.md](./archive/handoffs/HANDOFF-command-arch-target-resolution.md).
...
[HANDOFF-command-arch-output-contract.md](./archive/handoffs/HANDOFF-command-arch-output-contract.md).
...
> **Read [HANDOFF-command-arch-output-contract.md](./archive/handoffs/HANDOFF-command-arch-output-contract.md)
...
[HANDOFF-command-arch-manifest.md](./archive/handoffs/HANDOFF-command-arch-manifest.md).
...
> **Read [HANDOFF-command-arch-manifest.md](./archive/handoffs/HANDOFF-command-arch-manifest.md)
...
[HANDOFF-command-arch-metadata.md](./archive/handoffs/HANDOFF-command-arch-metadata.md).
...
> **Read [HANDOFF-command-arch-metadata.md](./archive/handoffs/HANDOFF-command-arch-metadata.md)
...
[HANDOFF_vitest-oxc-decorators.md](./archive/handoffs/HANDOFF_vitest-oxc-decorators.md).
...
> [HANDOFF-command-arch-bundles.md](./archive/handoffs/HANDOFF-command-arch-bundles.md).**
...
[HANDOFF-command-arch-mappers.md](./archive/handoffs/HANDOFF-command-arch-mappers.md).
...
- ~~**Core's `semantic-integration.ts` switch is a SECOND semantic→AST
  ...
  **not** reach `hyperscript.eval`'s English path, because that path is this
  ...
  [HANDOFF-command-arch-mappers.md](./archive/handoffs/HANDOFF-command-arch-mappers.md) § fact 2.
...
- ~~**`CommandWithParseInput` describes no real command, and `register(impl: any)`
  ...
  **The owner decision the filing asked for was answered — and three of its four
  ...
  [HANDOFF-command-arch-metadata.md](./archive/handoffs/HANDOFF-command-arch-metadata.md) § F-B1.
...
- **2026-07-29** — **Arc B brief written**
  ([HANDOFF-command-arch-metadata.md](./archive/handoffs/HANDOFF-command-arch-metadata.md)), arc
...
- **2026-07-29** — **Arc A CLOSED**, and its recommended follow-on (Finding 13,
  ...
  [HANDOFF-command-arch-manifest.md](./archive/handoffs/HANDOFF-command-arch-manifest.md); the
...
- **2026-07-28** — **Arc A brief written**
  ([HANDOFF-command-arch-manifest.md](./archive/handoffs/HANDOFF-command-arch-manifest.md)), arc
