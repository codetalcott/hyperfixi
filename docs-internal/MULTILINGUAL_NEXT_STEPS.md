...
> [CORRECTNESS_RELIABILITY_PLAN.md](./archive/plans/CORRECTNESS_RELIABILITY_PLAN.md) (§7a–§7cc, §11),
> [MULTILINGUAL_ROADMAP.md](./archive/plans/MULTILINGUAL_ROADMAP.md),
> [STRUCTURAL_ARCS_ROADMAP.md](./archive/plans/STRUCTURAL_ARCS_ROADMAP.md),
> [MULTILINGUAL_BEHAVIORS_PLAN.md](./archive/plans/MULTILINGUAL_BEHAVIORS_PLAN.md) and
> [BEHAVIORS_CONSOLIDATION_PLAN.md](./archive/plans/BEHAVIORS_CONSOLIDATION_PLAN.md). Read this first,
...
> [HANDOFF-r1-residual.md](./archive/handoffs/HANDOFF-r1-residual.md) landed in full, then its residue was swept via
> [HANDOFF-r1-post-cluster-residue.md](./archive/handoffs/HANDOFF-r1-post-cluster-residue.md) — both handoffs carry
...
> [HANDOFF-sov-literal-role-extraction.md](./archive/handoffs/HANDOFF-sov-literal-role-extraction.md) landed in three
> stacked increments:
>
...
> [HANDOFF-r1-residual.md](./archive/handoffs/HANDOFF-r1-residual.md) (five grounded clusters: SOV `set` role-swap +
...
> [`HANDOFF-lossy-tail.md`](./archive/handoffs/HANDOFF-lossy-tail.md).

> **Update 2026-06-26 (priority degenerate band → 0).** The last two priority
> degenerates are cleared (see
> [`HANDOFF-remaining-degenerate-singletons.md`](./archive/handoffs/HANDOFF-remaining-degenerate-singletons.md)):
...
> [`HANDOFF-lossy-tail.md`](./archive/handoffs/HANDOFF-lossy-tail.md). Note: the th lossy tail is NOT a
...
2. ~~**Fix `behavior-removable` — it is CURATED, so its failures are real bugs.**~~ **DONE**
   ...
   **all** non-English languages — fixed in [`transformer.ts`](../packages/i18n/src/grammar/transformer.ts).
   ...
   > [`HANDOFF-transformer-behavior-fidelity.md`](./archive/handoffs/HANDOFF-transformer-behavior-fidelity.md) — blamed
...
`docs-internal/archive/handoffs/HANDOFF_arc-e-fetch-with.md`).** The naked named-arg form is now captured
...
The colon-qualified event-name arc (`docs-internal/archive/handoffs/HANDOFF_colon-event-names.md`, resolved)
...
1. ~~**R3 role-VALUE audit (highest leverage).**~~ **DONE** (2026-07-10, the R3 arc —
   `docs-internal/archive/handoffs/HANDOFF_role-value-audit.md`, resolved). Landed exactly as designed:
...
2. ~~**qu behavior-resizable style-sets (the one remaining multiset row).**~~
   **DONE** (2026-07-10, transformer-rendering arc —
   `docs-internal/archive/handoffs/HANDOFF_transformer-rendering.md`, resolved). The diagnosis
...
(`docs-internal/archive/handoffs/HANDOFF_value-bug-families.md`, resolved). Per-family outcomes —
...
7. ~~**qu/tr behavior trigger-event residue — RE-FILED to the transformer arc**~~
   **DONE** (2026-07-10, transformer-rendering arc —
   `docs-internal/archive/handoffs/HANDOFF_transformer-rendering.md`, resolved; all four
...
`docs-internal/archive/plans/FRAMEWORK_SEMANTIC_BRIDGE_PLAN.md` ("a single lexicon", the
...
>    `docs-internal/archive/handoffs/HANDOFF_go-interchange-inference.md`.
...
notes are drafted** at `docs-internal/RELEASE_NOTES_v2.8.0-draft.md` (draft
deleted 2026-08-07 after shipping — see CHANGELOG.md and git history) — on
