...
predecessor brief, `docs-internal/archive/HANDOFF-parity-and-marker-tail.md`, is still the
...
> arc (#760) has merged to `main`. `docs-internal/archive/HANDOFF-learn-parity-and-markers.md`
