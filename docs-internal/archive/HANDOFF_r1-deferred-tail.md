...
> `docs-internal/archive/HANDOFF_r1-role-fidelity.md` (RESOLVED — this arc picks up its
> "Family D outcomes" deferrals; its method and traps carry over verbatim) and
> `docs-internal/archive/HANDOFF_transformer-rendering.md` (RESOLVED — the per-command
...
> come from).
>
> Working-tree note: `docs-internal/archive/HANDOFF_top-level-command-sequences.md`
