...
Companion scope doc: `docs-internal/archive/EXPRESSION_INTERNAL_TRANSLATION_SCOPE.md`. Memory:
...
3. `docs-internal/archive/EXPRESSION_INTERNAL_TRANSLATION_SCOPE.md` — the spec, § "Where the
   burndown stands".
