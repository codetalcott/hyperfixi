...
- **Audience split rationale:** in [`README.md`](../../hyperscript-org-offer/README.md) and
  [`integration-guide.md`](../../hyperscript-org-offer/integration-guide.md).
...
tree-shake) — but the [integration guide](../../hyperscript-org-offer/integration-guide.md) currently
...
[integration-guide.md](../../hyperscript-org-offer/integration-guide.md). For example:
...
[handoff.md pre-send checklist](../../hyperscript-org-offer/handoff.md), or wire into a
...
[integration-guide.md](../../hyperscript-org-offer/integration-guide.md) that:
...
[`docs-internal/hyperscript-org-offer/`](../../hyperscript-org-offer/README.md) has 5 markdown files now.
